...
function AllFoodListUpdatePart({ editData }) {
  ...
  useEffect(() => {
    if (editData) {
      setFormData(editData); // Populate form fields with existing data for editing
    }
  }, [editData]);
  ...
  return (
    <div>
      <h2>{editData ? "Edit Food" : "Create Food"}</h2>
...
export default AllFoodListUpdatePart;