...
const FoodTableFatch = (props) => {
 ...
 const hideCart = () =>{
  ...
  const handleDelete = (id) => {
    ...
    .then(willDelete => {
      if (willDelete) {
        ...
        fetch(`https://restaurantapi.bssoln.com/api/Food/delete/${id}`, {
      method: "DELETE",
    });
  ...
  const handleEdit = (id) => {
    // fetch(`https://restaurantapi.bssoln.com/api/Food/update/${id}`, {
    //   method: "GET",
    // });
    setEditedFood(employeeData.find((employee) => employee.id === id));
